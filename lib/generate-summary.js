 ...
 * @param {Object} [opts.dispatcher] - undici Dispatcher (for example a ProxyAgent) the API request is sent through; the module's own keep-alive agent when omitted
 *
